    ...
    <div class="max-w-7xl mx-auto">
        <div v-if="mainPosts.data.length > 0"
            ...
            <div class="flex flex-col gap-10 xl:order-0">
                <article class="lg:border-b lg:border-gray-200 lg:pb-2" v-for="secondaryPost in secondaryPosts"
            ...
            <div class="flex flex-col gap-10 lg:col-span-2 xl:col-span-1 xl:order-2 xl:gap-8">
                <article class="lg:border-b lg:border-gray-200 lg:pb-2" v-for="tertiaryPost in tertiaryPosts"
                    :key="tertiaryPost.id">
