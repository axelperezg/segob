                ...
                <div class="bg-white rounded-lg border border-gray-100 shadow-lg py-6 px-12">
                    ...
                    <div v-if="!document.data.isInfographic">
                        ...
                        <div class="flex flex-col space-y-4 items-center justify-between">
                            ...
                            <div class="text-gray-600">Página: {{ currentPage }} de {{ totalPages }}</div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg border border-gray-100 shadow p-6 mb-4">
                    <div class="space-y-4">
                        ...
                        <button
                            v-if="!document.data.isInfographic"
                            @click="downloadPDF"
                        ...
                        <button
                            v-if="document.data.isInfographic || document.data.images?.length > 0"
                ...
                <div
                    v-if="document.data.posts.length > 0"
