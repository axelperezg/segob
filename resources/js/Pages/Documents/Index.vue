...
<template>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-8">
            <PostsFilter :show-content-type="false" :show-dependency="false" :show-published-at="false"
                :show-document-section="true" route-name="documents.index" :route-params="{}" :filters="filters" />
            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3">
                        <DocumentArticle v-if="documents.data.length" v-for="document in documents.data"
                            :key="document.id" :document="document" />
                    </div>

                    <Pagination v-if="documents.meta.links.length > 3" :links="documents.meta.links"
