        ...
        <div class="pb-4">
            ...
            <div class="mt-4">
                <div v-show="activeTab === 1">
                    <div class="prose-lg max-w-7xl" v-html="postPresenter.content"></div>
                ...
                <div v-show="activeTab === 4" class="w-full h-screen">
                    <iframe :src="post.data.document?.document" class="w-full h-[80vh]" type="application/pdf"></iframe>
                    <div class="flex justify-center mb-4 mt-10">
                        <a
                            :href="post.data.document?.document"
                            download
